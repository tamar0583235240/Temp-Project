...
//     try {
//       await saveUserReminderSettings({
//         userId: "a40dc000-b446-409a-aa7b-3e778e8f4467",
//         settings: filteredSettings,
//       });
//       showMessage("התזכורות נשמרו בהצלחה!", "success");
//     } catch (error) {
...
//         {/* מציג את הטיפים לאחר שמירת ההגדרות */}
//         {selections.tips && (
//           // <ReminderComponent userId="810ab83a-87ad-4e20-9724-6b2ea9ced744" />
//           <ReminderComponent />
//         )}
//       </GridContainer>
//     </div>
  ...
  return (
    <div className="min-h-screen">
      <GridContainer maxWidth="md">
        ...
        {/* ✅ מציג טיפים רק אם המשתמש בחר אותם ולחץ על שמירה */}
        {remindersSaved && selections.tips && (
          <ReminderComponent />
        )}
      </GridContainer>
    </div>
